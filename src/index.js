...
function getCountry(name) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1.default)("https://restcountries.eu/rest/v2/name/" + name)];
                case 1:
                    getApi = _a.sent();
                    data = getApi.data[0];
                    return [2 /*return*/, {
...
function getRegionCountries(regionalbloc) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1.default)("https://restcountries.eu/rest/v2/regionalbloc/" + regionalbloc)];
                case 1:
                    getApi = _a.sent();
                    data = getApi.data;
                    countries = [];
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    promises = countryEndpoints.map(function (endpoint) {
                        return (0, axios_1.default)("https://restcountries.eu/rest/v2/name/" + endpoint);
                    });
